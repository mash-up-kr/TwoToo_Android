    ...
    override val flowerImage: FlowerImage = when (userType) {
        ME -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_tulip_me, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_tulip_me, width = 127.dp, height = 211.dp)
            }
        }
        PARTNER -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_tulip_partner, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_tulip_partner, width = 127.dp, height = 211.dp)
            }
        }
    }
}
