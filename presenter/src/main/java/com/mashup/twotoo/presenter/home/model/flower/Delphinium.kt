    ...
    override val flowerImage: FlowerImage = when (userType) {
        ME -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_delphinium_me, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_delphinium_me, width = 127.dp, height = 211.dp)
            }
        }
        PARTNER -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_delphinium_partner, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_delphinium_partner, width = 127.dp, height = 211.dp)
            }
        }
    }
}
