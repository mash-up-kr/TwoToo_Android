...
import com.mashup.twotoo.presenter.history.navigation.navigateToStandAloneHistoryDetail
    ...
    navigation(startDestination = NavigationRoute.HomeGraph.HomeScreen.route, route = NavigationRoute.HomeGraph.route) {
        composable(
            ...
            HomeRoute(
                ...
                navigateToStandAloneHistoryDetail = { commitNo -> navController.navigateToStandAloneHistoryDetail(commitNo) },
