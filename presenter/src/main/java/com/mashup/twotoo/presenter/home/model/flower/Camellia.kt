 ...
 */
data class Camellia(val userType: UserType, val growType: Stage) : FlowerType(
    name = FlowerName.Camellia,
) {
    override val flowerImage: FlowerImage = when (userType) {
        ME -> {
            when (growType) {
                ...
                Fourth -> FlowerImage(image = R.drawable.img_home_fourth_stage_camellia_me, width = 127.dp, height = 211.dp)
                Fifth -> FlowerImage(image = R.drawable.img_home_fifth_stage_camellia_me, width = 127.dp, height = 211.dp)
            }
        }
        PARTNER -> {
            when (growType) {
                ...
                Fourth -> FlowerImage(image = R.drawable.img_home_fourth_stage_camellia_partner, width = 127.dp, height = 211.dp)
                Fifth -> FlowerImage(image = R.drawable.img_home_fifth_stage_camellia_partner, width = 127.dp, height = 211.dp)
            }
        }
    }
}
