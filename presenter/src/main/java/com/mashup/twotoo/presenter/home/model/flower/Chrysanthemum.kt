    ...
    override val flowerImage: FlowerImage = when (userType) {
        ME -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_chrysanthemum_me, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_chrysanthemum_me, width = 127.dp, height = 211.dp)
            }
        }
        PARTNER -> {
            when (growType) {
                ...
                Flower -> FlowerImage(image = R.drawable.img_home_flower_chrysanthemum_partner, width = 127.dp, height = 211.dp)
                Bloom -> FlowerImage(image = R.drawable.img_home_bloom_chrysanthemum_partner, width = 127.dp, height = 211.dp)
            }
        }
    }
}
