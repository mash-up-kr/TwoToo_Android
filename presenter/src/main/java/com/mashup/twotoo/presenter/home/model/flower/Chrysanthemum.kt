 ...
 */
data class Chrysanthemum(val userType: UserType, val growType: Stage) : FlowerType(
    name = FlowerName.Chrysanthemum,
) {
    override val flowerImage: FlowerImage = when (userType) {
        ME -> {
            when (growType) {
                ...
                Fourth -> FlowerImage(image = R.drawable.img_home_fourth_stage_chrysanthemum_me, width = 127.dp, height = 211.dp)
                Fifth -> FlowerImage(image = R.drawable.img_home_fifth_stage_chrysanthemum_me, width = 127.dp, height = 211.dp)
            }
        }
        PARTNER -> {
            when (growType) {
                ...
                Fourth -> FlowerImage(image = R.drawable.img_home_fourth_stage_chrysanthemum_partner, width = 127.dp, height = 211.dp)
                Fifth -> FlowerImage(image = R.drawable.img_home_fifth_stage_chrysanthemum_partner, width = 127.dp, height = 211.dp)
            }
        }
    }
}
