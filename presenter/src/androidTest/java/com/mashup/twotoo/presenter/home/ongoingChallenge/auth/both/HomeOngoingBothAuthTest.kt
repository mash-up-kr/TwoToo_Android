package com.mashup.twotoo.presenter.home.ongoingChallenge.auth.both
...
class HomeOngoingBothAuthTest {
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_1단계() {
        createTest(
            partnerStage = Stage.Zero,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_2단계() {
        createTest(
            partnerStage = Stage.Zero,
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_3단계() {
        createTest(
            partnerStage = Stage.Zero,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_4단계() {
        createTest(
            partnerStage = Stage.Zero,
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_0단계_me_5단계() {
        createTest(
            partnerStage = Stage.Zero,
            meStage = Stage.Fifth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_1단계() {
        createTest(
            partnerStage = Stage.First,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_2단계() {
        createTest(
            partnerStage = Stage.First,
            meStage = Stage.Second,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_3단계() {
        createTest(
            partnerStage = Stage.First,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_4단계() {
        createTest(
            partnerStage = Stage.First,
            meStage = Stage.Fourth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_1단계_me_5단계() {
        createTest(
            partnerStage = Stage.First,
            meStage = Stage.Fifth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_1단계() {
        createTest(
            partnerStage = Stage.Second,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_2단계() {
        createTest(
            partnerStage = Stage.Second,
            meStage = Stage.Second,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_3단계() {
        createTest(
            partnerStage = Stage.Second,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_4단계() {
        createTest(
            partnerStage = Stage.Second,
            meStage = Stage.Fourth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_2단계_me_5단계() {
        createTest(
            partnerStage = Stage.Second,
            meStage = Stage.Fifth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_1단계() {
        createTest(
            partnerStage = Stage.Third,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_2단계() {
        createTest(
            partnerStage = Stage.Third,
            meStage = Stage.Second,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_3단계() {
        createTest(
            partnerStage = Stage.Third,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_4단계() {
        createTest(
            partnerStage = Stage.Third,
            meStage = Stage.Fourth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_3단계_me_5단계() {
        createTest(
            partnerStage = Stage.Third,
            meStage = Stage.Fifth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_1단계() {
        createTest(
            partnerStage = Stage.Fourth,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_2단계() {
        createTest(
            partnerStage = Stage.Fourth,
            meStage = Stage.Second,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_3단계() {
        createTest(
            partnerStage = Stage.Fourth,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_4단계() {
        createTest(
            partnerStage = Stage.Fourth,
            meStage = Stage.Fourth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_4단계_me_5단계() {
        createTest(
            partnerStage = Stage.Fourth,
            meStage = Stage.Fifth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_0단계() {
        createTest(
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_1단계() {
        createTest(
            partnerStage = Stage.Fifth,
            meStage = Stage.First,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_2단계() {
        createTest(
            partnerStage = Stage.Fifth,
            meStage = Stage.Second,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_3단계() {
        createTest(
            partnerStage = Stage.Fifth,
            meStage = Stage.Third,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_4단계() {
        createTest(
            partnerStage = Stage.Fifth,
            meStage = Stage.Fourth,
        )
    ...
    @Test
    fun 챌린지_생성후_AuthBoth일때_partner_5단계_me_5단계() {
        createTest(
            partnerStage = Stage.Fifth,
            meStage = Stage.Fifth,
        )
